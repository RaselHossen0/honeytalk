...
import type { HeadFrameGiftRecord } from '@/types/head-frame';
import { demoHeadFrameGiftRecords } from '@/lib/demo-data';

export default function HeadFrameGiftRecordPage() {
  const addTab = useTabsStore((s) => s.addTab);
  const [data] = useState<HeadFrameGiftRecord[]>(demoHeadFrameGiftRecords);
  ...
  useEffect(() => {
    addTab({
      id: '/dashboard/head-frame/gift-record',
      label: 'Gift Record',
      path: '/dashboard/head-frame/gift-record',
      breadcrumbs: ['Home', 'Prop management', 'head frame', 'Gift Record'],
    });
  }, [addTab]);
          ...
          <Table size="small">
            <TableHead>
              <TableRow sx={{ bgcolor: 'grey.50' }}>
                ...
                <TableCell sx={{ fontWeight: 600 }}>Gifted time(Days)</TableCell>
