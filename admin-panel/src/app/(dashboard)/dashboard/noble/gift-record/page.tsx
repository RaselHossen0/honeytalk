...
import type { NobleGiftRecord } from '@/types/noble';
import { demoNobleGiftRecords } from '@/lib/demo-data';

export default function NobleGiftRecordPage() {
  const addTab = useTabsStore((s) => s.addTab);
  const [data] = useState<NobleGiftRecord[]>(demoNobleGiftRecords);
  ...
  useEffect(() => {
    addTab({
      id: '/dashboard/noble/gift-record',
      label: 'Gift Record',
      path: '/dashboard/noble/gift-record',
      breadcrumbs: ['Home', 'Prop management', 'Noble Management', 'Gift Record'],
    });
  }, [addTab]);
