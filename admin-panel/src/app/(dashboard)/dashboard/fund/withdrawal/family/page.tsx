...
import { demoFamilyWithdrawals } from '@/lib/demo-data';

const STATUS_OPTIONS = ['Select', 'Pending', 'Pending Review', 'Completed', 'Rejected'];

export default function FamilyWithdrawalListPage() {
  const addTab = useTabsStore((s) => s.addTab);
  const [data, setData] = useState<Withdrawal[]>(demoFamilyWithdrawals);
  ...
  useEffect(() => {
    addTab({
      id: '/dashboard/fund/withdrawal/family',
      label: 'Family Withdrawal List',
      path: '/dashboard/fund/withdrawal/family',
      breadcrumbs: ['Home', 'Fund Management', 'Withdrawal management', 'Family Withdrawal List'],
    });
  }, [addTab]);
  ...
  const handleExport = () => {
    alert('Export functionality would download family withdrawal list data.');
  };
